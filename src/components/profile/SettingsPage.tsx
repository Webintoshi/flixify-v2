    ...
    return (
        <div className="animate-in fade-in duration-500">
            <header className="mb-10">
                <h1 className="text-4xl font-black tracking-tight mb-2">AYARLAR</h1>
                <p className="text-gray-400 font-bold uppercase tracking-widest text-sm">Hesap ayarlarınızı yönetin</p>
            </header>
